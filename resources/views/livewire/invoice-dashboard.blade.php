    ...
    <div class="bg-white shadow-md rounded-lg my-10  p-6">
        ...
        <div class="flex justify-between items-center w-100 flex-wrap">
            ...
            <div class="flex items-center gap-2 flex-wrap">
                <div class="relative">
                    <button wire:click="toggleFilter" class="px-3 py-1 text-sm text-[#6d6d6d] font-semibold border rounded shadow-md flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M19 6H5c-1.1 0-1.4.6-.6 1.4l4.2 4.2c.8.8 1.4 2.3 1.4 3.4v5l4-2v-3.5c0-.8.6-2.1 1.4-2.9l4.2-4.2c.8-.8.5-1.4-.6-1.4" />
                        </svg>
                        Filter
                    </button>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex gap-2 sm:flex-row flex-col">
                                    <div class="sm:w-1/2 w-full">
                                        ...
                                        <input wire:model.live="filterDateFrom" type="date" class="border rounded-lg text-base text-black border-[#d9d9d9] w-full">
                                    </div>
                                    <div class="sm:w-1/2 w-full">
                                        <label class="text-base">To Date</label>
                                        <input wire:model.live="filterDateTo" type="date" class="border rounded-lg text-base text-black border-[#d9d9d9] w-full">
                                    </div>
                                </div>
                ...
                <button wire:click="$dispatch('open-create-invoice-modal')" class="create-invoice px-3 py-1.5 text-sm text-white border rounded shadow-md bg-[#6875f5] flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
        ...
        <div class="w-full mb-4">
            <div class="border-b-2 flex gap-10 overflow-auto">
                ...
                @foreach ($tabs as $tab)
                    <button wire:click="setTab('{{ $tab }}')" class="p-0 py-2 text-base font-semibold whitespace-nowrap {{ $activeTab === $tab ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-400 ' }}">
                        {{ $tab }}
                    </button>
                @endforeach
            </div>
                    ...
                    <tbody>
                        @foreach ($invoices as $invoice)
                            <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <span class="d-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 16 16">
                                                <path fill="none" stroke="#797979" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="1.5" d="M4.75 10.75h-3m12.5-2c0 3-2.798 5.5-6.25 5.5c-3.75 0-6.25-3.5-6.25-3.5v3.5m9.5-9h3m-12.5 2c0-3 2.798-5.5 6.25-5.5c3.75 0 6.25 3.5 6.25 3.5v-3.5" />
                                            </svg>
                                        </span>
                                    </div>
                                </td>
                                <td class="p-2 text-base font-semibold text-gray-600 whitespace-nowrap">
                                    <span class="px-2 py-1 rounded-[3px] text-xs font-semibold 
                                ...
                                <td class="p-2 text-base font-semibold text-gray-600 relative whitespace-nowrap" x-data="{ isOpen: false }">
                                    <button @click="isOpen = !isOpen" class="text-gray-500 hover:text-gray-700 dropdown-container">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 16 16">
